...
The Bergen Bysykkel 2024 project analyzes bicycle rental patterns across Bergen, Norway, using historical data from Bysykkel and supplementary weather observations. This analysis is part of a two-stage initiative:

**Part 1** focuses on foundational tasks: cleaning rental data, building station-specific linear regression models, and visualizing bike traffic patterns across the city using dynamic maps.

**Part 2** will integrate weather data and employ advanced predictive modeling techniques to refine our understanding of rental trends.
